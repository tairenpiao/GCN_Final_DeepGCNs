...
class OptInit:
    def __init__(self):
        ...
        parser.add_argument('--exp_name', type=str, default='sem_seg', help='prefix of saved file')
        ...
        # train args
        parser.add_argument('--total_epochs', default=50, type=int, help='number of total epochs to run')
